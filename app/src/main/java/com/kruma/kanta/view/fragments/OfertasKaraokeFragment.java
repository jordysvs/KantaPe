...
public class OfertasKaraokeFragment extends Fragment {
    ...
    private OfertasKaraokeFragment.VerificarAperturaDialog dg_gProceso;
    ...
    public OfertasKaraokeFragment() {
        // Required empty public constructor
    }

    public static OfertasKaraokeFragment newInstance(String param1, String param2) {
        OfertasKaraokeFragment fragment = new OfertasKaraokeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_ofertas_karaoke, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((KaraokesActivity) getActivity()).getSupportActionBar().setSubtitle("NOVEDADES");
        ...
        if (com.kruma.core.security.SecurityManager.getKey(Constante.SESSION_IDLOCAL) != null) {
            dg_gProceso = new OfertasKaraokeFragment.VerificarAperturaDialog();
            dg_gProceso.execute();
        }
            ...
            com.kruma.kanta.logical.AperturaUsuario.ObtenerEstadoAperturaUsuario(
                    ...
                    new ProcessCallback<AperturaUsuario>() {
                        ...
                        public void failure(ProcessResult obj_pResultado) {
                            ...
                            bln_Termino = true;
                            OfertasKaraokeFragment.VerificarAperturaDialog.this.cancel(true);
                        }
                    });
...
/*
    ...
    private void ListarOferta() {
        ...
        com.kruma.kanta.logical.Oferta.ListarOfertaSinVencer(
