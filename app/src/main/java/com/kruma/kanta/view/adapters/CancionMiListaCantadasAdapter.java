 ...
 */
public class CancionMiListaCantadasAdapter extends BaseAdapter {

    static AperturaCancion obj_pAperturaCancion;
    public static int id;
    private Context context;
    private static List<AperturaCancion> lsCancionMiListaCantadasEntities;

    public CancionMiListaCantadasAdapter(Context context, List<AperturaCancion> lsCancionMiListaCantadasEntities) {
        this.context = context;
        this.lsCancionMiListaCantadasEntities = lsCancionMiListaCantadasEntities;
    }

    @Override
    public int getCount() {
        return lsCancionMiListaCantadasEntities.size();
    }

    @Override
    public Object getItem(int position) {
        return lsCancionMiListaCantadasEntities.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            CancionMiListaCantadasAdapter.ViewHolder holder = new CancionMiListaCantadasAdapter.ViewHolder();
        ...
        AperturaCancion obj_pAperturaCancion = lsCancionMiListaCantadasEntities.get(position);
        ...
        if (obj_pAperturaCancion != null ) {
            ...
            Integer int_IdAperturaCancionSolicitud = 0;
                ...
                CancionMiListaCantadasAdapter.ViewHolder holder = (CancionMiListaCantadasAdapter.ViewHolder) v.getTag();
                ...
                holder.txtCancion.setTextColor(holder.txtCancion.getContext().getResources().getColor(R.color.colorSecondaryText));
                holder.txtCantante.setTextColor(holder.txtCantante.getContext().getResources().getColor(R.color.colorSecondaryText));
                holder.txtGenero.setTextColor(holder.txtGenero.getContext().getResources().getColor(R.color.colorSecondaryText));
                holder.txtIdioma.setTextColor(holder.txtIdioma.getContext().getResources().getColor(R.color.colorSecondaryText));
    ...
    public static AperturaCancion getAperturaCancion(int pos) {
        return obj_pAperturaCancion = lsCancionMiListaCantadasEntities.get(pos);
    }

    public static int getIdAperturaCancion(int pos) {
        return id = lsCancionMiListaCantadasEntities.get(pos).getIdAperturaCancion();
    }
