...
/**
 * Created by  Enrique on 27/07/2016.
 */
public class NovedadesAdapter extends BaseAdapter {
    ...
    public NovedadesAdapter(Context context, List<LocalCancion> lsCancionEntities) {
    ...
    public static int getIdLocalCancion(int pos) {
        return id = lsCancionEntities.get(pos).getIdLocalCancion();
    }
