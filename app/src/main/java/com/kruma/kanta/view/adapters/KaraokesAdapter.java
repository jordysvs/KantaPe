 ...
 */
public class KaraokesAdapter extends BaseAdapter {
    ...
    public KaraokesAdapter(Context context, List<Local> lsLocalEntities) {
    ...
    public static String getNombre(int pos) {
        ...
        return nombre = lsLocalEntities.get(pos).getNombre();
    }
