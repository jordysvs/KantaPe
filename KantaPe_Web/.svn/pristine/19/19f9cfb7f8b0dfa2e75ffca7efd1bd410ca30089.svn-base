...
public partial class Redireccionar : System.Web.UI.Page
{
    ...
    //    string str_pNombreCompleto, int? int_pIdTipoDocumento, string str_pNumeroDocumento,
    //    int? int_pNumPagina, int? int_pTamPagina)
    //{
    //    return Kruma.Core.Business.Logical.Empleado.Listar(null, str_pNombreCompleto, int_pIdTipoDocumento, str_pNumeroDocumento, null, null, Kruma.Core.Business.Entity.Constante.Estado_Activo, int_pNumPagina, int_pTamPagina);
    //}
    #endregion
