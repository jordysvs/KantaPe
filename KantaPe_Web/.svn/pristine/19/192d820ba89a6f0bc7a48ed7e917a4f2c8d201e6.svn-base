...
function ListarReporte() {
    ...
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "La cama incendiada";
    obj_Item.Item3 = "Cama Incendiada";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "10";
    lst_Lista.push(obj_Item);

    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "La Prisión";
    obj_Item.Item3 = "Cama incendiada";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "20";
    ...
    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "Chamán";
    obj_Item.Item3 = "Sueños Liquidos";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "30";
    lst_Lista.push(obj_Item);
    ...
    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "Tú tienes lo que quiero";
    obj_Item.Item3 = "Sueños Liquidos";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "15";
    ...
    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "Clavado en un bar";
    obj_Item.Item3 = "Sueños Liquidos";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "18";
    ...
    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "En el muelle de San Blas";
    obj_Item.Item3 = "Sueños Liquidos";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "22";
    ...
    obj_Item = new Object();
    obj_Item.Item1 = "Mana";
    obj_Item.Item2 = "Me voy a convertir en un ave";
    obj_Item.Item3 = "Sueños Liquidos";
    obj_Item.Item4 = "Rock";
    obj_Item.Item5 = "Español Latino";
    obj_Item.Item6 = "2";
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>N° Búsquedas</th>"));
    ...
    if (obj_pLista != null) {
        ...
        for (var i = 0; i < obj_pLista.length; i++) {
            ...
            obj_FilaPrincipal.append($("<td style='text-align:center;'>" + obj_pLista[i].Item6 + "</td>"));
