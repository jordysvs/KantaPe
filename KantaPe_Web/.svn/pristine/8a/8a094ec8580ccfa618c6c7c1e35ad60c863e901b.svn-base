...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="true" >
        <Scripts>
            ...
            <div class="box box box-warning">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNroDocumento" runat="server" CssClass="form-control soloNumeros" ClientIDMode="Static" MaxLength="20" />
                    </div>
                    <div class="form-group">
                        <label for="txtCelular">Celular:</label>
                        <asp:TextBox ID="txtCelular" runat="server" CssClass="form-control soloNumeros" ClientIDMode="Static" MaxLength="20" />
                    </div>
                </div>
            </div>
        </div>
