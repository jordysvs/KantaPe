...
namespace Kruma.KantaPe.Negocio
{
    ...
    public class Local
    {
        ...
        public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Local> Listar(
            ...
            int? int_pTamPagina)
        {
            Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Local> lst_Lista = Kruma.KantaPe.Data.Local.Listar(
                int_pIdLocal,
                int_pIdEmpresa,
                int_pIdDireccion,
                str_pNombre,
            ...
            foreach (Kruma.KantaPe.Entidad.Local obj_Local in lst_Lista.Result)
                obj_Local.ImagenURL = ObtenerLocalImagenURL(obj_Local.IdLocal);
        ...
        public static ProcessResult Insertar(Kruma.KantaPe.Entidad.Local obj_pLocal)
        {
            ...
            try
            {
                ...
                if (Kruma.KantaPe.Negocio.Local.Listar(null, obj_pLocal.IdEmpresa, null, obj_pLocal.Nombre, null, null, null, null, null, null, null, null, null, null, null, null).Result.Count > 0)
                {
        ...
        public static ProcessResult Modificar(Kruma.KantaPe.Entidad.Local obj_pLocal)
        {
            ...
            try
            {
                ...
                using (TransactionScope obj_Transaction = new TransactionScope())
                {
                    ...
                    obj_LocalAModificar.Promocion = obj_pLocal.Promocion;
        ...
        /// <item><FecCrea>09/11/2017</FecCrea></item></list></remarks>
        public static string ObtenerLocalImagenURL(int? int_pIdRegistro)
        {
            ...
            Kruma.Core.FileServer.FileServerManager obj_FileServerManager = new Kruma.Core.FileServer.FileServerManager();
            System.Collections.Generic.List<Kruma.Core.FileServer.Entity.FileUpload> lst_Fotos = obj_FileServerManager.getFiles(int_IdAlmacen.Value, int_pIdRegistro.Value);
            if (lst_Fotos.Count > 0)
            {
                ...
                str_UrlImagen = string.Format("{0}Ashx/FileServerViewHandler.ashx?ref={1}",
                    ...
                    string.Format("{0}|{1}|{2}", int_IdAlmacen, int_pIdRegistro, lst_Fotos[0].IdDocumento)
                    ));
            }
