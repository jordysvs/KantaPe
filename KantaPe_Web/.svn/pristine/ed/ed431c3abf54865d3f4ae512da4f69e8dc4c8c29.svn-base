<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Local.aspx.cs" Inherits="Forms_Maestro_Local" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Compress="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/Local.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtHoraInicio" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="2" placeholder="Ingrese la hora inicio" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="txtHoraFin">Hora Fin:</label>
                                <asp:TextBox ID="txtHoraFin" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="2" placeholder="Ingrese la hora fin" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPais" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="ddlDepartamento">Departamento:</label>
                                <asp:DropDownList ID="ddlDepartamento" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDistrito" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                </div>
