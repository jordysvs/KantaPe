<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Dispositivo.aspx.cs" Inherits="Forms_Seguridad_Dispositivo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/Dispositivo.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Código">Ip:</label>
                                <asp:TextBox ID="txtIp" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="20" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Nombre">Host Name:</label>
                                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
