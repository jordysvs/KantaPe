<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Almacen.aspx.cs" Inherits="Forms_Seguridad_Almacen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/Almacen.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="20" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
