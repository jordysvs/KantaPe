<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="AprobarSolicitud.aspx.cs" Inherits="Forms_Maestro_AprobarSolicitud" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/AprobarSolicitud.js" />
        </Scripts>
    </cc:ScriptCombine>
                            ...
                            <div class="box box box-warning">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="txtDescripcionAlbum">Titulo:</label>
                                                <asp:TextBox ID="txtDescripcionAlbum" runat="server" ClientIDMode="Static" CssClass="form-control" placeholder="Ingrese el titulo del album">
                                                </asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
