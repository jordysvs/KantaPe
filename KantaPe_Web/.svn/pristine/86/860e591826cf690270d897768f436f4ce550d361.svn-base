<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="ReporteAperturaMesa.aspx.cs" Inherits="Forms_Reporte_ReporteAperturaMesa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombine" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Minify="false">
        <Scripts>
            <cc:ScriptReference Path="~/Script/Forms/Reporte/ReporteAperturaMesa.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtMozo" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="50" placeholder="Ingrese el mozo" />

                            </div>
                            <%--<div class="form-group">
                                <label for="txtMozo">Mozo:</label>
                                <div id="txtMozo" class="input-group">
                                    <input id="txtPersona_input" name="ctl00$cphBody$txtPersona_input" type="text" class="form-control" readonly="readonly" placeholder="Seleccione un mozo">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Top 5 de cantidad de aperturas por mesa</h3>
                                    <div class="box-tools pull-right">
                        ...
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <h3 class="box-title">Top 5 de mozos que más aperturan mesas</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                    </div>
