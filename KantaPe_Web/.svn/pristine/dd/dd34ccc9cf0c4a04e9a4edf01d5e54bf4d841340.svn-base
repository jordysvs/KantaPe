create PROCEDURE [dbo].[ListarUbicacionAperturaBoxGrafico] 
/*
'**********************************************************************************
'* Procedimiento almacenado de [ListarUbicacionAperturaBoxGrafico]
'* Input :
