...
function CargarLocal(bln_pAsync, int_pIdLocal) {
    ...
    if (int_IdPersona != '') {
        ...
        AccionDefault(bln_pAsync, "RegistroUsuario.aspx/ListarLocal", obj_Data,
             function (obj_pLista) {
...
function GuardarUsuario() {
    ...
    if (blnValid) {
        ...
        obj_Usuario.IdEmpresa = $("#ddlEmpresa").val();
        obj_Usuario.IdLocal = $("#ddlLocal").val();
...
function ObtenerUsuario() {
    ...
    if (str_IdUsuario != '') {
        ...
        if (obj_Usuario != null) {
            ...
            var obj_Empleado = ObtenerData("RegistroUsuario.aspx/ObtenerEmpleado", { "int_pIdPersona": obj_Usuario.IdPersona });
            if (obj_Empleado != null) {
                $("#ddlEmpresa").val(obj_Empleado.IdEmpresa);
                CargarLocal(true, obj_Empleado.IdLocal);
            }
