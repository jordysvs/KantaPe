<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroIdioma.aspx.cs" Inherits="Forms_Maestro_RegistroIdioma" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/RegistroIdioma.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDescripcion" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control" placeholder="Ingrese descripción" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
