<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroAlbum.aspx.cs" Inherits="Forms_Maestro_RegistroAlbum" %>

<%@ Register TagPrefix="cc" Namespace="Kruma.Core.Util.Web.Combine.Controls" Assembly="Kruma.Core.Util.Web" %>

<%@ Register Src="../../Ascx/Forms/Maestro/BuscadorArtista.ascx" TagName="BuscadorArtista" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/BuscadorArtista.js" />
            <cc:ScriptReference Path="~/Script/Forms/Maestro/RegistroAlbum.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTitulo" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control" placeholder="Ingrese título del álbum" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <uc1:BuscadorArtista ID="ucBuscadorArtista" runat="server" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
