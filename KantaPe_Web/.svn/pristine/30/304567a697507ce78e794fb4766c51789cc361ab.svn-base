...
function Exportar() {
    $('body').prepend("<form id='excelForm' method='post' action='../../Ashx/Reporte/ReporteCancionPedidaExcel.ashx'></form>");
    $('#excelForm').submit();
    $("excelForm").remove();
}
function ObtenerFiltros() {
    ...
    obj_Filtro.DesArtista = $("#txtArtista").val();
    obj_Filtro.DesAlbum = $("#txtAlbum").val();
    ...
    if ($("#txtFechaInicio_input").val() != '') {
        ...
        obj_Filtro.FechaInicio = DiaActual;

        //Darle Valor a la fecha
        var Mes = DiaActual.getMonth() + 1, Dia = DiaActual.getDate(), Ano = DiaActual.getFullYear();
        if (Dia < 10) { Dia = "0" + Dia; }
        if (Mes < 10) { Mes = "0" + Mes; }
        var Fecha = Dia + "/" + Mes + "/" + Ano;
        $("#txtFechaInicio_input").val(Fecha);
    }
...
function ListarReporte() {
    ...
    var obj_Data = {
        ...
        "str_pDesArtista": obj_Filtro.DesArtista,
        "str_pDesAlbum": obj_Filtro.DesAlbum,
    ...
    AccionDefault(true, "ReporteCancionPedida.aspx/ReporteCancionPedida", obj_Data, CargarGrilla, null, null, null, 1);
}
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:10%'>Pedidos</th>"));
    obj_THead.append(obj_FilaPrincipal);
    obj_TablaPrincipal.append(obj_THead);

    var int_pIdCancion = 0;

    if (obj_pLista != null) {
        var obj_TBody = $("<tbody></tbody>");
        for (var i = 0; i < obj_pLista.Result.length; i++) {
            var str_Pedido = $("#txtPedido").val();
            if (obj_pLista.Result[i].CantidadPedido >= str_Pedido || str_Pedido == '' || str_Pedido == null) {
                var str_Album = '';
                if (obj_pLista.Result[i].LocalCancion.Album.Titulo != null) {
                    str_Album = obj_pLista.Result[i].LocalCancion.Album.Titulo;
                }
                obj_FilaPrincipal = $("<tr></tr>");
                obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].LocalCancion.DesEmpresa + "</td>"));
                obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].LocalCancion.DesLocal + "</td>"));
                ...
                obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].LocalCancion.Genero.Descripcion + "</td>"));
                obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].LocalCancion.Idioma.Descripcion + "</td>"));
                obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].CantidadPedido + "</td>"));
        ...
        ListarGraficoCancionPedida(obj_pLista);
        ListarArtistaTop(1);
        ListarGeneroTop(1);
        ListarIdiomaTop(1);
...
function ListarGraficoCancionPedida(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        ...
        if (obj_pLista.Result[i].CantidadPedido >= str_Pedido || str_Pedido == '' || str_Pedido == null) {
            ...
            str_pCantidadPedido = obj_pLista.Result[i].CantidadPedido;
            str_pTitulo = obj_pLista.Result[i].LocalCancion.Cancion.Descripcion;

            //obj_FilaPrincipal = $("<tr></tr>");
            //obj_FilaPrincipal.append($("<td>" + str_pTitulo + "</td>"));
            //obj_FilaPrincipal.append($("<td>" + str_pCantidadPedido + "</td>"));
    ...
    obj_tick.push([0, str_pTituloUno]);
    obj_tick.push([1, str_pTituloDos]);
    obj_tick.push([2, str_pTituloTres]);
    obj_tick.push([3, str_pTituloCuatro]);
    obj_tick.push([4, str_pTituloCinco]);
...
//***********************GRAFICO TOP 5 ARTISTA*****************
function ListarArtistaTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "dt_pFechaInicio": obj_Filtro.FechaInicio,
        "dt_pFechaFin": obj_Filtro.FechaFin,
    ...
    AccionDefault(true, "ReporteCancionPedida.aspx/ListarArtistaTop", obj_Data, ListarGraficoArtistaPedida, null, null, null, 1);
}
function ListarGraficoArtistaPedida(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        ...
        if (obj_pLista.Result[i].CantidadPedido >= str_Pedido || str_Pedido == '' || str_Pedido == null) {
            str_pCantidadPedido = obj_pLista.Result[i].CantidadPedido;
            str_pTitulo = obj_pLista.Result[i].Artista.Nombre;
...
//***********************GRAFICO TOP 5 GENERO*****************
function ListarGeneroTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "dt_pFechaInicio": obj_Filtro.FechaInicio,
        "dt_pFechaFin": obj_Filtro.FechaFin,
    ...
    AccionDefault(true, "ReporteCancionPedida.aspx/ListarGeneroTop", obj_Data, ListarGraficoGeneroPedida, null, null, null, 1);
}
function ListarGraficoGeneroPedida(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        ...
        if (obj_pLista.Result[i].CantidadPedido >= str_Pedido || str_Pedido == '' || str_Pedido == null) {
            str_pCantidadPedido = obj_pLista.Result[i].CantidadPedido;
            str_pTitulo = obj_pLista.Result[i].Genero.Descripcion;
            str_pLocal = obj_pLista.Result[i].Local.Direccion;
    ...
    somePlot = $.plot("#divGrafico3", [series], {
        grid: {
            hoverable: true,
            borderWidth: 1,
            borderColor: "#f3f3f3",
...
//***********************GRAFICO TOP 5 IDIOMA*****************
function ListarIdiomaTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "dt_pFechaInicio": obj_Filtro.FechaInicio,
        "dt_pFechaFin": obj_Filtro.FechaFin,
    ...
    AccionDefault(true, "ReporteCancionPedida.aspx/ListarIdiomaTop", obj_Data, ListarIdiomaGeneroPedida, null, null, null, 1);
}
function ListarIdiomaGeneroPedida(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        ...
        if (obj_pLista.Result[i].CantidadPedido >= str_Pedido || str_Pedido == '' || str_Pedido == null) {
            ...
            str_pCantidadPedido = obj_pLista.Result[i].CantidadPedido;
            str_pTitulo = obj_pLista.Result[i].Idioma.Descripcion;
            str_pLocal = obj_pLista.Result[i].Local.Direccion;
    ...
    somePlot = $.plot("#divGrafico4", [series], {
        grid: {
            hoverable: true,
            borderWidth: 1,
            borderColor: "#f3f3f3",
...
function CargarLocal(bln_pAsync, int_pIdDireccion) {
    ...
    if (int_IdPersona != '') {
        ...
        AccionDefault(bln_pAsync, "ReporteCancionPedida.aspx/ListarLocal", obj_Data,
             function (obj_pLista) {
