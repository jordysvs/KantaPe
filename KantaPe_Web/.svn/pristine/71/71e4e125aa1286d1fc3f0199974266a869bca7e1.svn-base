<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroEmpresa.aspx.cs" Inherits="Forms_Maestro_RegistroEmpresa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/RegistroEmpresa.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtRUC" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control soloNumeros" placeholder="Ingrese el RUC" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtRazonSocial" runat="server" ClientIDMode="Static" MaxLength="100" CssClass="form-control" placeholder="Ingrese la razón social" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNombreComercial" runat="server" ClientIDMode="Static" MaxLength="100" CssClass="form-control" placeholder="Ingrese el nombre comercial" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
