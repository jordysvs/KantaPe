<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Empleado.aspx.cs" Inherits="Forms_Configuracion_Empleado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Minify="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Configuracion/Empleado.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNumeroDocumento" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el número de documento" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="txtNombreCompleto">Nombre:</label>
                                <asp:TextBox ID="txtNombreCompleto" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el nombre" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
