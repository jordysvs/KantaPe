<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Insumo.aspx.cs" Inherits="Forms_Maestro_Insumo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/Insumo.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el código" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="txtDescripcion">Descripción:</label>
                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese la descripción" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="ddlUnidadMedida">Unidad de Medida:</label>
                                <asp:DropDownList ID="ddlUnidadMedida" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
