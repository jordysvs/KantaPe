...
public partial class Forms_Portal_Karaoke : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        //obj_MasterPage.TituloPagina = "Karaoke";
    }
    ...
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Oferta> ListarOfertas(int? int_pIdLocal)
    {
        ...
        foreach (Kruma.KantaPe.Entidad.Oferta obj_Oferta in lst_Oferta.Result)
        {
            if (obj_Oferta.IdImagen != null)
                obj_Oferta.ImagenURL = ObtenerImagenURL(int_IdAlmacenLocal.Value, obj_Oferta.IdImagen, str_pImagenURLDefecto);
        }
    ...
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Evento> ListarEventos(int? int_pIdLocal)
    {
        ...
        foreach (Kruma.KantaPe.Entidad.Evento obj_Evento in lst_Evento.Result)
        {
            if (obj_Evento.IdEvento.HasValue)
                obj_Evento.ImagenURL = ObtenerImagenURL(int_IdAlmacenLocal.Value, obj_Evento.IdImagen, str_pImagenURLDefecto);
        }
    ...
    /// </summary>
    /// <param name="int_pIdLocal">Id de local</param>
    /// <remarks><list type="bullet">
    /// <item><CreadoPor>Vicente Gonzales Osorio</CreadoPor></item>
    /// <item><FecCrea>1/04/2017</FecCrea></item></list></remarks>
    [WebMethod]
    ...
    [WebMethod]
    public static string ObtenerImagenURLGrilla(int? int_pIdRegistro)
    {
