...
public partial class Forms_Configuracion_Producto : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        obj_MasterPage.TituloPagina = "Producto";
        ...
        ddlProductoTipo.Items.Insert(0, new ListItem("--Todos--", string.Empty));
    ...
    [WebMethod]
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Producto> ListarProducto(
            int? int_pIdEmpresa,
            int? int_pIdLocal,
            string str_pNombre,
            ...
            int? int_pTamPagina)
    {
        return Kruma.KantaPe.Negocio.Producto.Listar(
            int_pIdEmpresa,
            int_pIdLocal,
            null,
            str_pNombre,
    ...
    public static Kruma.Core.Util.Common.ProcessResult ModificarEstado(
        int int_pIdLocal, int int_pIdProducto, string str_pEstado)
    {
        Kruma.KantaPe.Entidad.Producto obj_Producto = new Kruma.KantaPe.Entidad.Producto();
        obj_Producto.IdLocal = int_pIdLocal;
        obj_Producto.IdProducto = int_pIdProducto;
        obj_Producto.Estado = str_pEstado;
        return Kruma.KantaPe.Negocio.Producto.ModificarEstado(obj_Producto);
    }
    [WebMethod]
