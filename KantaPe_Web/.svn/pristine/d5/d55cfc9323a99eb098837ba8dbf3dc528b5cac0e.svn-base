<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Usuario.aspx.cs" Inherits="Forms_Seguridad_Usuario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/Usuario.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="20" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Nombre">Nombre:</label>
                                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="50" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlModulo" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="Perfil">Perfil:</label>
                                <asp:DropDownList ID="ddlPerfil" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
