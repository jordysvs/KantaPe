...
public partial class Forms_Seguridad_RegistroUsuario : System.Web.UI.Page
{
    ...
    public static List<Kruma.Core.Security.Entity.PerfilUsuario> ListarPerfil(string str_pIdUsuario)
    {
        ...
        foreach (Kruma.Core.Security.Entity.Perfil obj_Perfil in lst_Perfil)
        {
            obj_PerfilUsuarioResultado = (from obj_PerfilUsuario in lst_PerfilUsuario
                                          where obj_PerfilUsuario.IdPerfil == obj_Perfil.IdPerfil
    ...
    public static Kruma.Core.Util.Common.ProcessResult GuardarUsuario(string str_pUsuario, string str_pIdUsuario)
    {
        ...
        Kruma.KantaPe.Entidad.Usuario obj_Usuario = obj_JsSerializer.Deserialize<Kruma.KantaPe.Entidad.Usuario>(str_pUsuario);
        ...
        if (string.IsNullOrEmpty(str_pIdUsuario))
            obj_Resultado = Kruma.KantaPe.Negocio.Usuario.Insertar(obj_Usuario);
        else
            obj_Resultado = Kruma.KantaPe.Negocio.Usuario.Modificar(obj_Usuario);
    ...
    //OBTENER EMPLEADO
    [WebMethod]
    public static Kruma.KantaPe.Entidad.Empleado ObtenerEmpleado(int? int_pIdPersona)
    {
        return Kruma.KantaPe.Negocio.Empleado.Obtener(null, int_pIdPersona);
    }
    #endregion
