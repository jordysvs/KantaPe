<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="ReporteCancionNoKaraoke.aspx.cs" Inherits="Forms_Reporte_ReporteCancionNoKaraoke" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombine" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Minify="false">
        <Scripts>
            <cc:ScriptReference Path="~/Script/Forms/Reporte/ReporteCancionNoKaraoke.js" />
        </Scripts>
    </cc:ScriptCombine>
                        ...
                        <div class="col-lg-12">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Top 5 de total de canciones no existente en karaoke</h3>
                                    <div class="box-tools pull-right">
