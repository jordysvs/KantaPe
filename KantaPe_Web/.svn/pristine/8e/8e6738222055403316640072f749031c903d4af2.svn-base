...
public partial class Forms_Seguridad_Usuario : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Usuario> ListarUsuario(int? int_pIdEmpresa, int? int_pIdLocal, string str_pIdUsuario, string str_pNombreCompleto, string str_pIdPerfil, string str_pEstado, int? int_pNumPagina, int? int_pTamPagina)
    {
        string str_Sistema = Kruma.Core.Security.SecurityManager.Usuario.Sistema;
        if (str_Sistema == Kruma.Core.Security.Entity.Constante.Condicion_Positivo)
            str_Sistema = string.Empty;
        ...
        Kruma.Core.Criptography.CriptographyManager obj_CriptographyManager = new Kruma.Core.Criptography.CriptographyManager();
        Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Usuario> lst_Usuario = Kruma.KantaPe.Negocio.Usuario.Listar(null, null, null, str_pNombreCompleto, str_pIdUsuario, str_pIdPerfil, null, str_pEstado, int_pIdEmpresa, int_pIdLocal, int_pNumPagina, int_pTamPagina);
        foreach (Kruma.Core.Security.Entity.Usuario obj_Usuario in lst_Usuario.Result)
            obj_Usuario.Clave = obj_CriptographyManager.Dencrypt(obj_Usuario.Clave);
        return lst_Usuario;
    }
