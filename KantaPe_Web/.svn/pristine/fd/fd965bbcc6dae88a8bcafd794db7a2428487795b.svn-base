...
public partial class Forms_Configuracion_LocalCancion : System.Web.UI.Page
{
    #region Eventos
    ...
    [WebMethod]
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.LocalCancion> ListarLocalCancion(
        int? int_pIdEmpresa,
        int? int_pIdLocal,
        string str_pTitulo,
        string str_pArtista,
    ...
    public static Kruma.Core.Util.Common.ProcessResult ModificarEstado(
        int int_pIdLocal, int int_pIdCancion, string str_pEstado)
    {
        Kruma.KantaPe.Entidad.LocalCancion obj_LocalCancion = new Kruma.KantaPe.Entidad.LocalCancion();
        obj_LocalCancion.IdLocal = int_pIdLocal;
        obj_LocalCancion.IdCancion = int_pIdCancion;
        obj_LocalCancion.Estado = str_pEstado;
        return Kruma.KantaPe.Negocio.LocalCancion.ModificarEstado(obj_LocalCancion);
    }
