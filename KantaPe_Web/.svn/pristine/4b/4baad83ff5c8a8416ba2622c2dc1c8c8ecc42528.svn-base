<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Empresa.aspx.cs" Inherits="Forms_Maestro_Empresa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/Empresa.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtRUC" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el nro. de documento" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="txtRazonSocial">Razón Social:</label>
                                <asp:TextBox ID="txtRazonSocial" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese la razón social" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="txtNombreComercial">Nombre Comercial:</label>
                                <asp:TextBox ID="txtNombreComercial" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el nomnre comercial" />
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
