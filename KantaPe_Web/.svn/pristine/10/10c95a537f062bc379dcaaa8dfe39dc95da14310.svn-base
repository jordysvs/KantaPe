<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroPersona.aspx.cs" Inherits="Forms_Seguridad_RegistroPersona" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/RegistroPersona.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNroDocumento" runat="server" CssClass="form-control soloNumeros" ClientIDMode="Static" MaxLength="20" placeholder="Ingrese el número de documento" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
