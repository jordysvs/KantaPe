...
public partial class Forms_Configuracion_Oferta : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        obj_MasterPage.TituloPagina = "Oferta";
    ...
    /// <summary>
    /// Lista de oferta del local
    /// </summary>
    /// <param name="int_pIdEmpresa">Id de la empresa</param>
    /// <param name="int_pIdLocal">Id del local</param>
    /// <param name="str_pNombre">Nombre de la oferta</param>
    /// <param name="dtm_pFechaInicio">Fecha de inicio de la oferta</param>
    /// <param name="dtm_pFechaFin">Fecha fin de la oferta</param>
    /// <param name="str_pEstado">Estado de la oferta</param>
    /// <param name="int_pNumPagina">Número de página</param>
    /// <param name="int_pTamPagina">Tamaño de la página</param>
    /// <returns></returns>
    [WebMethod]
    public static Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Oferta> ListarOferta(
            int? int_pIdEmpresa,
            int? int_pIdLocal,
            string str_pNombre,
            ...
            int? int_pTamPagina)
    {
        return Kruma.KantaPe.Negocio.Oferta.Listar(
            int_pIdEmpresa,
            int_pIdLocal,
            null,
            str_pNombre,
    ...
    public static Kruma.Core.Util.Common.ProcessResult ModificarEstado(
        int int_pIdLocal, int int_pIdOferta, string str_pEstado)
    {
        Kruma.KantaPe.Entidad.Oferta obj_Oferta = new Kruma.KantaPe.Entidad.Oferta();
        obj_Oferta.IdLocal = int_pIdLocal;
        obj_Oferta.IdOferta = int_pIdOferta;
        obj_Oferta.Estado = str_pEstado;
        return Kruma.KantaPe.Negocio.Oferta.ModificarEstado(obj_Oferta);
    }

    /// <summary>
    /// Listado de locales de la empresa
    /// </summary>
    /// <param name="int_pIdEmpresa">Id de la empresa</param>
