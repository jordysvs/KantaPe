<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroUbicacion.aspx.cs" Inherits="Forms_Configuracion_RegistroUbicacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Compress="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Base/jquery.validate/jquery.validate.js" />
            <cc:ScriptReference Path="~/Script/Forms/Configuracion/RegistroUbicacion.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNumero" runat="server" CssClass="form-control soloNumeros" ClientIDMode="Static" placeholder="Ingrese el número" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCapacidad" runat="server" CssClass="form-control soloNumeros" ClientIDMode="Static" placeholder="Ingrese la capacidad" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <asp:HiddenField ID="hdIdUbicacion" runat="server" ClientIDMode="Static" />
