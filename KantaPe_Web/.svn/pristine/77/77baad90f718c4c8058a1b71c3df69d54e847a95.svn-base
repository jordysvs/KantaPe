<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroInsumo.aspx.cs" Inherits="Forms_Maestro_RegistroInsumo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/RegistroInsumo.js" />
        </Scripts>
    </cc:ScriptCombine>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control" placeholder="Ingrese el código" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDescripcion" runat="server" ClientIDMode="Static" MaxLength="100" CssClass="form-control" placeholder="Ingrese la descripción" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlUnidadMedida" runat="server" ClientIDMode="Static" CssClass="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <asp:HiddenField ID="hdIdInsumo" runat="server" ClientIDMode="Static" />
</asp:Content>
