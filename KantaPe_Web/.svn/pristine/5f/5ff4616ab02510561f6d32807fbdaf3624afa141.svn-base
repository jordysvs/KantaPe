<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Evento.aspx.cs" Inherits="Forms_Configuracion_Evento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Configuracion/Evento.js" />
        </Scripts>
    </cc:ScriptCombine>
            ...
            <div class="box box-warning collapsed-box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtFechaInicio">Fecha de Evento Del:</label>
