    ...
    public class AperturaCancion
    {
            ...
            int? int_pTamPagina)
        {
            ...
            foreach (Kruma.KantaPe.Entidad.AperturaCancion obj_AperturaCancion in lst_Lista.Result)
            {
                ...
                if (obj_AperturaCancion.LocalCancion.IdArtista != null)
                    obj_AperturaCancion.LocalCancion.Artista.ImagenURL = Kruma.KantaPe.Negocio.LocalCancion.ObtenerArtistaImagenURL(obj_AperturaCancion.LocalCancion.IdArtista);
            }
