<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="NuevasCanciones.aspx.cs" Inherits="Forms_Maestro_NuevasCanciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/NuevasCanciones.js" />
        </Scripts>
    </cc:ScriptCombine>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTitulo" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el título" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtArtista">Artista:</label>
                                <asp:TextBox ID="txtArtista" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el artista" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtAlbum">Album:</label>
                                <asp:TextBox ID="txtAlbum" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el título del álbum" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtGenero" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el genero" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtIdioma">Idioma:</label>
                                <asp:TextBox ID="txtIdioma" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="100" placeholder="Ingrese el idioma" />
                            </div>
                        </div>
                        <%--    <div class="col-lg-4">
                            <div class="form-group">
            ...
            <div class="box box-warning">
                <div class="box-header">
                    <div class="btn-group">
                        ...
                        <button id="btnAprobar" title="Aprobar" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-floppy-saved"></i></button>
                        <button id="btnRechazar" title="Rechazar" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-floppy-remove"></i></button>
                    </div>
    ...
    <div class="modal fade colored-header danger" id="mdBuscador" tabindex="-1" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtMotivo" runat="server" CssClass="form-control" ClientIDMode="Static" TextMode="MultiLine" Rows="6" placeholder="Ingrese le motivo de rechazo" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <asp:HiddenField ID="hdIdSolicitudCancion" runat="server" ClientIDMode="Static" />
