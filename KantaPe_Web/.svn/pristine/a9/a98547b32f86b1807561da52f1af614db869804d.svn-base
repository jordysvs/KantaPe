...
function ListarReporte() {
    ...
    obj_Item.Item5 = "01/07/2016";
    obj_Item.Item6 = "Bebida";
    obj_Item.Item7 = "Cerveza Cusqueña";
    obj_Item.Item8 = "3";
    obj_Item.Item9 = "S/.10.00";
    obj_Item.Item10 = "S/.30.00";
    ...
    obj_Item.Item3 = "002";
    obj_Item.Item4 = "Miguel Rivera";
    obj_Item.Item5 = "01/07/2016";
    obj_Item.Item6 = "Bebida";
    obj_Item.Item7 = "Chilcano";
    obj_Item.Item8 = "1";
    obj_Item.Item9 = "S/.12.00";
    obj_Item.Item10 = "S/.24.00";
    lst_Lista.push(obj_Item);

    obj_Item = new Object();
    obj_Item.Item1 = "Norkys";
    obj_Item.Item2 = "Soprano Av. La Lince";
    obj_Item.Item3 = "003";
    obj_Item.Item4 = "Johana Ramirez";
    obj_Item.Item5 = "01/07/2016";
    obj_Item.Item6 = "Bebida";
    obj_Item.Item7 = "Chilcano";
    obj_Item.Item8 = "1";
    obj_Item.Item9 = "S/.10.00";
    obj_Item.Item10 = "S/.10.00";
    lst_Lista.push(obj_Item);

    obj_Item = new Object();
    obj_Item.Item1 = "Norkys";
    obj_Item.Item2 = "Soprano Av. La Arequipa";
    obj_Item.Item3 = "004";
    obj_Item.Item4 = "Carlos Sanchez";
    obj_Item.Item5 = "01/07/2016";
    obj_Item.Item6 = "Piqueo";
    obj_Item.Item7 = "Tequeño";
    obj_Item.Item8 = "1";
    obj_Item.Item9 = "S/.8.00";
    obj_Item.Item10 = "S/.8.00";
    lst_Lista.push(obj_Item);
    ...
    obj_Item.Item2 = "Soprano Av. La Lince";
    obj_Item.Item3 = "005";
    obj_Item.Item4 = "Miguel More";
    obj_Item.Item5 = "01/07/2016";
    obj_Item.Item6 = "Piqueo";
    obj_Item.Item7 = "Alitas de pollo";
    obj_Item.Item8 = "1";
    obj_Item.Item9 = "S/.12.00";
    obj_Item.Item10 = "S/.12.00";
    lst_Lista.push(obj_Item);
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Nro. Pedido</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Usuario</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Fecha</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Tipo de Producto</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Producto</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Cantidad</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Precio</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Total</th>"));
    ...
    if (obj_pLista != null) {
        ...
        for (var i = 0; i < obj_pLista.length; i++) {
            ...
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item8 + "</td>"));
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item9 + "</td>"));
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item10 + "</td>"));
            obj_TBody.append(obj_FilaPrincipal);
        }
        obj_TablaPrincipal.append(obj_TBody);

        ListarGraficoBebidas(obj_pLista);
        ListarGraficoPiqueos(obj_pLista);
...
function ListarGraficoBebidas(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    obj_tick.push([0, "Chilcano<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([1, "Cerveza Barena<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([2, "Cerveza Cusqueña<br>(Soprano Av. La Molina)"]);
    obj_tick.push([3, "Chilcano Maracuya<br>(Soprano Av. La Marina)"]);
    obj_tick.push([4, "Cerveza Pilsen<br>(Soprano Av. Miraflores)"]);
...
function ListarGraficoPiqueos(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    obj_tick.push([0, "Tequeños<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([1, "Alitas de Pollo<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([2, "Bolitas de Yuca<br>(Soprano Av. La Molina)"]);
    obj_tick.push([3, "Yuquitas fritas<br>(Soprano Av. La Marina)"]);
    obj_tick.push([4, "Tequeños<br>(Soprano Av. Miraflores)"]);
