...
function ListarReporte() {
    ...
    obj_Item.Item3 = "Juan Perez";
    obj_Item.Item4 = "01/07/2016 23:00";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "Hechicera";
    ...
    obj_Item.Item3 = "Marlon Rivera";
    obj_Item.Item4 = "01/07/2016 23:30";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "Un lobo por tu amor";
    obj_Item.Item7 = "Sueños Liquidos";
    obj_Item.Item8 = "Rock";
    obj_Item.Item9 = "Español Latino";
    obj_Item.Item10 = "8";
    ...
    obj_Item.Item3 = "Carlos Rojas";
    obj_Item.Item4 = "01/07/2016 23:50";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "Como dueles en los labios";
    obj_Item.Item7 = "Sueños Liquidos";
    obj_Item.Item8 = "Rock";
    obj_Item.Item9 = "Español Latino";
    obj_Item.Item10 = "6";
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Tiempo(min)</th>"));
    ...
    if (obj_pLista != null) {
        ...
        for (var i = 0; i < obj_pLista.length; i++) {
            ...
            obj_FilaPrincipal.append($("<td style='text-align:center;'>" + obj_pLista[i].Item10 + "</td>"));
            obj_TBody.append(obj_FilaPrincipal);
        }
        obj_TablaPrincipal.append(obj_TBody);

        //ListarGraficoVehiculosIncompletos(obj_pLista);
