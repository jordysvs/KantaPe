    ...
    public class Oferta
    {
            ...
            int? int_pTamPagina)
        {
            ...
            foreach (DataRow obj_Row in dt_Resultado.Rows)
            {
                ...
                obj_Oferta.FlagPromocion = obj_Row["FlagPromocion"] is DBNull ? Kruma.KantaPe.Entidad.Constante.Condicion_Negativo : obj_Row["FlagPromocion"].ToString();
                obj_Oferta.FechaPromocion = obj_Row["FechaPromocion"] is DBNull ? null : (DateTime?)obj_Row["FechaPromocion"];
        ...
        public static Core.Util.Common.List<.Entidad.Distrito> ListarDemo(
        int? int_pIdEmpresa,
        string str_pNombre,
        string str_pDescripcion,
        DateTime? dtm_pFechaInicio,
        ...
        int? int_pTamPagina)
        {
            Core.Util.Common.List<Entidad.Distrito> obj_Lista = new Core.Util.Common.List<.Entidad.Distrito>();
            obj_Lista.PageNumber = int_pNumPagina;
            obj_Lista.Total = 0;
       ...
       int? int_pTamPagina)
        ...
        public static int Insertar(Kruma.KantaPe.Entidad.Oferta obj_pOferta)
        {
            ...
            dop_Operacion.Parameters.Add(new Parameter("@pFlagPromocion", obj_pOferta.FlagPromocion));

            Parameter obj_FechaPromocion = new Parameter("@pFechaPromocion", DbType.DateTime);
            obj_FechaPromocion.Direction = ParameterDirection.Input;
            obj_FechaPromocion.Value = obj_pOferta.FechaPromocion.Value;
            dop_Operacion.Parameters.Add(obj_FechaPromocion);
