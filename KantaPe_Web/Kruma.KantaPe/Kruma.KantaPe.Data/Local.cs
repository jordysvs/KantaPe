    ...
    public class Local
    {
            ...
            int? int_pTamPagina)
        {
            ...
            foreach (DataRow obj_Row in dt_Resultado.Rows)
            {
                ...
                obj_Local.Promocion = obj_Row["Promocion"] is DBNull ? 0 : (int)obj_Row["Promocion"];
        ...
        {
            Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.Local> lst_Local = Listar(int_pIdLocal, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        public static int Insertar(Kruma.KantaPe.Entidad.Local obj_pLocal)
        {
            ...
            dop_Operacion.Parameters.Add(new Parameter("@pPromocion", obj_pLocal.Promocion));
