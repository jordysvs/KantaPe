...
function ListarReporte() {
    ...
    obj_Item.Item2 = "Soprano Av. Arequipa";
    obj_Item.Item3 = "Mana";
    obj_Item.Item4 = "Adicto a tu amor";
    obj_Item.Item5 = "Cama Incendiada";
    obj_Item.Item6 = "Rock";
    obj_Item.Item7 = "Español Latino";
    lst_Lista.push(obj_Item);
    ...
    obj_Item.Item3 = "Mana";
    obj_Item.Item4 = "La cama incendiada";
    obj_Item.Item5 = "Cama Incendiada";
    obj_Item.Item6 = "Rock";
    obj_Item.Item7 = "Español Latino";
    lst_Lista.push(obj_Item);
...
function ListarGraficoCancion(obj_pLista) {
    ...
    obj_tick.push([0, "Soprano Av. Arequipa"]);
    obj_tick.push([1, "Soprano Av. Arequipa"]);
    obj_tick.push([2, "Soprano Av. La Marina"]);
    obj_tick.push([3, "Soprano Av. La Molina"]);
    obj_tick.push([4, "Soprano Av. Miraflores"]);
