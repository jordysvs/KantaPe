...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Insumo</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Stock Minimo</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Stock Actual</th>"));
    ...
    if (obj_pLista != null) {
        ...
        for (var i = 0; i < obj_pLista.length; i++) {
            ...
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item4 + "</td>"));
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item5 + "</td>"));
            obj_TBody.append(obj_FilaPrincipal);
        }
        obj_TablaPrincipal.append(obj_TBody);

        ListarGraficoInsumoRapido(obj_pLista);
        ListarGraficoInsumoLento(obj_pLista);
...
function ListarGraficoInsumoRapido(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    obj_tick.push([0, "Limón<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([1, "Limón<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([2, "Maracuya<br>(Soprano Av. La Marina)"]);
    obj_tick.push([3, "Pollo<br>(Soprano Av. La Molina)"]);
    obj_tick.push([4, "Papa<br>(Soprano Av. Miraflores)"]);
...
function ListarGraficoInsumoLento(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
    ...
    obj_tick.push([0, "Mani<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([1, "Lechuga<br>(Soprano Av. Arequipa)"]);
    obj_tick.push([2, "Yuca<br>(Soprano Av. La Marina)"]);
    obj_tick.push([3, "Azucar<br>(Soprano Av. La Molina)"]);
    obj_tick.push([4, "Sal<br>(Soprano Av. Miraflores)"]);
