...
function Exportar() {
    $('body').prepend("<form id='excelForm' method='post' action='../../Ashx/Reporte/ReporteUsuarioFrecuenteExcel.ashx'></form>");
    $('#excelForm').submit();
    $("excelForm").remove();
}
function ObtenerFiltros() {
    ...
    obj_Filtro.DesUsuario = $("#txtUsuario").val();
...
function ListarReporte() {
    ...
    var obj_Data = {
        "str_pNombreCompleto": obj_Filtro.DesUsuario,
    ...
    AccionDefault(true, "ReporteUsuarioFrecuente.aspx/ReporteUsuarioFrecuente", obj_Data, CargarGrilla, null, null, null, 1);
}
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Usuario</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Correo</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Empresa</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Local</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Frecuencia</th>"));
    ...
    var obj_TBody = $("<tbody></tbody>");
        ...
        for (var i = 0; i < obj_pLista.Result.length; i++) {
            str_IdPersona = obj_pLista.Result[i].Persona.IdPersona;

            //OBTENER
            var obj_Filtro = ObtenerFiltros();
            var lst_Comparacion = ObtenerData('ReporteUsuarioFrecuente.aspx/ReporteUsuarioFrecuenteComparacion', {
                "str_pNombreCompleto": obj_Filtro.DesUsuario,
                "int_pIdEmpresa": obj_Filtro.IdEmpresa,
                "int_pIdLocal": obj_Filtro.IdLocal,
                "dt_pFechaInicio": obj_Filtro.FechaInicio,
            ...
            //Comparar para sacar la cantidad
            for (var x = 0; x < lst_Comparacion.Result.length; x++) {
                var str_IdPersonaComparacion = lst_Comparacion.Result[x].Persona.IdPersona;
                if (str_IdPersonaComparacion == str_IdPersona) {
                    str_Cantidad++;
                }
            }
            ...
            obj_FilaPrincipal.append($("<td>" + obj_pLista.Result[i].Persona.Mail + "</td>"));
            ...
            obj_FilaPrincipal.append($("<td>" + str_Cantidad + "</td>"));

            //Ponerlo en la lista para el grafico
            var obj_UsuarioFrecuente = Object();
            obj_UsuarioFrecuente.NombreCompleto = obj_pLista.Result[i].NombreCompleto;
            obj_UsuarioFrecuente.Local = obj_pLista.Result[i].Local.Direccion;
            obj_UsuarioFrecuente.Cantidad = str_Cantidad;
            lst_UsuarioFrecuente.push(obj_UsuarioFrecuente);
        ...
        ListarGraficoKaraoke(lst_UsuarioFrecuente);
        ListarUsuarioPideCancionesTop(1);
        //ListarGraficoConsumo(obj_pLista);
        //ListarGraficoCancelanPedido(obj_pLista);
...
function ListarGraficoKaraoke(lst_UsuarioFrecuente) {
    var obj_data = [];
    var obj_tick = [];
    ...
    var obj_TBody = $("<tbody></tbody>");
    for (var i = 0; i < lst_UsuarioFrecuente.length; i++) {

        str_pCantidadPedido = lst_UsuarioFrecuente[i].Cantidad;
        str_pTitulo = lst_UsuarioFrecuente[i].NombreCompleto;
        str_pLocal = lst_UsuarioFrecuente[i].Local;
...
function ListarUsuarioPideCancionesTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "str_pNombreCompleto": obj_Filtro.DesUsuario,
        "dt_pFechaInicio": obj_Filtro.FechaInicio,
    ...
    AccionDefault(true, "ReporteUsuarioFrecuente.aspx/ListarUsuarioPideCancionesTop", obj_Data, ListarGraficoNuevasCanciones, null, null, null, 1);
}
function ListarGraficoNuevasCanciones(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
