...
function ListarReporte() {
    ...
    obj_Item.Item4 = "01";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "En el muelle de San Blas";
    obj_Item.Item7 = "Sueños Liquidos";
    obj_Item.Item8 = "Rock";
    obj_Item.Item9 = "Español Latino";
    obj_Item.Item10 = "1";
    obj_Item.Item11 = "1";
    obj_Item.Item12 = "01/07/2016";
    lst_Lista.push(obj_Item);

    obj_Item = new Object();
    obj_Item.Item1 = "Norkys";
    obj_Item.Item2 = "Soprano Av. Lince";
    obj_Item.Item3 = "Mesa";
    obj_Item.Item4 = "02";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "Adicto a tu amor";
    obj_Item.Item7 = "Cama Incendiada";
    obj_Item.Item8 = "Rock";
    obj_Item.Item9 = "Español Latino";
    obj_Item.Item10 = "2";
    obj_Item.Item11 = "1";
    ...
    obj_Item.Item4 = "01";
    obj_Item.Item5 = "Mana";
    obj_Item.Item6 = "La cama incendiada";
    obj_Item.Item7 = "Cama Incendiada";
    obj_Item.Item8 = "Rock";
    obj_Item.Item9 = "Español Latino";
    obj_Item.Item10 = "1";
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Tipo Ubicación</th>"));
    ...
    //obj_FilaPrincipal.append($("<th style='width:15%'>Genero</th>"));
    //obj_FilaPrincipal.append($("<th style='width:15%'>Idioma</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Nro. Pedidos</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Nro. Cantados</th>"));
    ...
    if (obj_pLista != null) {
        ...
        for (var i = 0; i < obj_pLista.length; i++) {
            ...
            obj_FilaPrincipal.append($("<td style='text-align:right;'>" + obj_pLista[i].Item11 + "</td>"));
