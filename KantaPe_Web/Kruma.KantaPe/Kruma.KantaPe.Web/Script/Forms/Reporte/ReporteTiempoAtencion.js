...
function CargarLocal(bln_pAsync, int_pIdDireccion) {
    ...
    if (int_IdPersona != '') {
        ...
        AccionDefault(bln_pAsync, "ReporteTiempoAtencion.aspx/ListarLocal", obj_Data,
             function (obj_pLista) {
...
function Exportar() {
    $('body').prepend("<form id='excelForm' method='post' action='../../Ashx/Reporte/ReporteTiempoAtencionExcel.ashx'></form>");
    $('#excelForm').submit();
    $("excelForm").remove();
}
...
function ListarReporte() {
    ...
    AccionDefault(true, "ReporteTiempoAtencion.aspx/ReporteTiempoAtencion", obj_Data, CargarGrilla, null, null, null, 1);
}
...
function CargarGrilla(obj_pLista) {
    ...
    obj_FilaPrincipal.append($("<th style='width:15%'>Mozo</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Fecha</th>"));
    obj_FilaPrincipal.append($("<th style='width:10%'>Alerta Tipo</th>"));
    obj_FilaPrincipal.append($("<th style='width:15%'>Tipo de Ubicación</th>"));
    obj_FilaPrincipal.append($("<th style='width:10%'>Ubicación</th>"));
    obj_FilaPrincipal.append($("<th style='width:5%'>Tiempo de atención (min)</th>"));
    obj_THead.append(obj_FilaPrincipal);
    obj_TablaPrincipal.append(obj_THead);

    var obj_TBody = $("<tbody></tbody>");
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        var str_FechaApertura = obj_pLista.Result[i].FechaApertura == null ? '' : ToDateTimeString(obj_pLista.Result[i].FechaApertura);
        ...
        var str_AlertaTipo = obj_pLista.Result[i].Alerta.AlertaTipo.Descripcion == null ? '' : obj_pLista.Result[i].Alerta.AlertaTipo.Descripcion;
        ...
        obj_FilaPrincipal.append($("<td>" + str_AlertaTipo + "</td>"));
    ...
    ListarTiempoAtencionMozoRapidoTop(1);
    ListarTiempoAtencionMozoLentoTop(1);
...
function ListarTiempoAtencionMozoRapidoTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "str_pNombreCompleto": obj_Filtro.DesMozo,
        "int_pIdEmpresa": obj_Filtro.IdEmpresa,
    ...
    AccionDefault(true, "ReporteTiempoAtencion.aspx/ListarTiempoAtencionMozoTop", obj_Data, ListarGraficoMozosMasRapidos, null, null, null, 1);
}
function ListarGraficoMozosMasRapidos(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];

    var str_pCantidadUno = "";
    var str_pCantidadDos = "";
    var str_pCantidadTres = "";
    var str_pCantidadCuatro = "";
    var str_pCantidadCinco = "";
    ...
    var obj_TBody = $("<tbody></tbody>");
    for (var i = 0; i < obj_pLista.Result.length; i++) {
        var str_pDiferencia = obj_pLista.Result[i].DiferenciaFechas / obj_pLista.Result[i].Cantidad;
        str_pCantidadPedido = str_pDiferencia;
        str_pTitulo = obj_pLista.Result[i].NombreCompleto;
        str_pLocal = obj_pLista.Result[i].Local.Direccion;

        if ((str_pCantidadPedido < str_pCantidadUno || (str_pCantidadUno == "")) && str_pDiferencia!=0) {
                //Cantidad
            ...
            if ((str_pCantidadPedido < str_pCantidadDos || (str_pCantidadDos== "")) && str_pDiferencia!=0) {
                    //Cantidad
                    str_pCantidadCinco = str_pCantidadCuatro
                    str_pCantidadCuatro = str_pCantidadTres
                    str_pCantidadTres = str_pCantidadDos
                ...
                if ((str_pCantidadPedido < str_pCantidadTres || (str_pCantidadTres == "")) && str_pDiferencia != 0) {
                        //Cantidad
                        str_pCantidadCinco = str_pCantidadCuatro
                        str_pCantidadCuatro = str_pCantidadTres
                    ...
                    if ((str_pCantidadPedido < str_pCantidadCuatro || (str_pCantidadCuatro == "")) && str_pDiferencia != 0) {
                            //Cantidad
                            str_pCantidadCinco = str_pCantidadCuatro
                        ...
                        if ((str_pCantidadPedido < str_pCantidadCinco || (str_pCantidadDos == "")) && str_pDiferencia != 0) {
    ...
    if (str_pCantidadUno != "")
        obj_data.push([0, str_pCantidadUno.toFixed(0)]);
    else
        obj_data.push([0, str_pCantidadUno]);
    if (str_pCantidadDos != "")
        obj_data.push([1, str_pCantidadDos.toFixed(0)]);
    else
        obj_data.push([1, str_pCantidadTres]);
    if (str_pCantidadTres != "")
        obj_data.push([2, str_pCantidadTres.toFixed(0)]);
    else
        obj_data.push([2, str_pCantidadTres]);
    if (str_pCantidadCuatro!="")
        obj_data.push([3, str_pCantidadCuatro.toFixed(0)]);
    else
        obj_data.push([3, str_pCantidadCuatro]);
    if (str_pCantidadCinco != "")
        obj_data.push([4, str_pCantidadCinco.toFixed(0)]);
    else
...
function ListarTiempoAtencionMozoLentoTop() {
    var obj_Filtro = ObtenerFiltros();
    var obj_Data = {
        "str_pNombreCompleto": obj_Filtro.DesMozo,
        "int_pIdEmpresa": obj_Filtro.IdEmpresa,
    ...
    AccionDefault(true, "ReporteTiempoAtencion.aspx/ListarTiempoAtencionMozoTop", obj_Data, ListarGraficoMozosMasLentos, null, null, null, 1);
}
function ListarGraficoMozosMasLentos(obj_pLista) {
    var obj_data = [];
    var obj_tick = [];
