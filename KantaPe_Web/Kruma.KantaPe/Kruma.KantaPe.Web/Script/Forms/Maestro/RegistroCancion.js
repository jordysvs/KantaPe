...
function InicializarCancionBuscador(obj_pData) {
    ...
    $ddlCancion =
        $("#ddlCancion").select2({
            ...
            ajax: {
                url: "RegistroCancion.aspx/ListarCancion",
...
function GuardarCancionSimple() {
    ...
    if ($('#frmContent').valid()) {
        ...
        AccionDefault(true, "RegistroCancion.aspx/AgregarCancion", { "str_pDescripcion": str_DescripcionValidado },
...
function GuardarGenero() {
    ...
    if ($('#frmContent').valid()) {
        ...
        AccionDefault(true, "RegistroCancion.aspx/AgregarGenero", { "str_pDescripcion": str_DescripcionValidado },
            function (obj_pResultado) {
                var lst_Centro = [];
                var obj_Centro = new Object();
                obj_Centro.id = obj_pResultado.ReturnId;
...
function GuardarIdioma() {
    ...
    if ($('#frmContent').valid()) {
        ...
        AccionDefault(true, "RegistroCancion.aspx/AgregarIdioma", { "str_pDescripcion": str_DescripcionValidado },
            function (obj_pResultado) {
                var lst_Centro = [];
                var obj_Centro = new Object();
                obj_Centro.id = obj_pResultado.ReturnId;
...
function GuardarAlbum() {
    ValidacionAlbum();
    if ($('#frmContent').valid()) {
        var str_Descripcion = $("#txtDescripcionArtistaAlbum").val().toLowerCase();
