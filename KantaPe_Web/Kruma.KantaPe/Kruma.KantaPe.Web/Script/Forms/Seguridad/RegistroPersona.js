...
function cargarInicial() {
    ...
    $('#frmContent').validate({
        ...
        messages: {
            ...
            ctl00$cphBody$txtCorreo: { required: 'Ingrese el correo' },
            ctl00$cphBody$txtNroDocumento: { required: 'Ingrese el numero de documento' },
