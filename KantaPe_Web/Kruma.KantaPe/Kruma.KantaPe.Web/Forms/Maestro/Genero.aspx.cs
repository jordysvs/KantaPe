...
public partial class Forms_Maestro_Genero : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        obj_MasterPage.TituloPagina = "Género";
    ...
    [WebMethod]
    public static object ListarGenero(
        string str_pDescripcion, string str_pEstado, int? int_pNumPagina, int? int_pTamPagina)
    {
        ...
        return Kruma.KantaPe.Negocio.Genero.Listar(str_pDescripcion, str_pEstado, int_pNumPagina, int_pTamPagina);
    }

    [WebMethod]
    public static Kruma.Core.Util.Common.ProcessResult ModificarEstado(
        int int_pIdGenero, string str_pEstado)
    {
        Kruma.KantaPe.Entidad.Genero obj_Genero = new Kruma.KantaPe.Entidad.Genero();
        obj_Genero.IdGenero = int_pIdGenero;
        obj_Genero.Estado = str_pEstado;
        return Kruma.KantaPe.Negocio.Genero.ModificarEstado(obj_Genero);
    }
