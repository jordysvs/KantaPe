<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroArtista.aspx.cs" Inherits="Forms_Maestro_RegistroArtista" %>

<%@ Register TagPrefix="cc" Namespace="Kruma.Core.Util.Web.Combine.Controls" Assembly="Kruma.Core.Util.Web" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">

    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" AppCacheDuration="0" BrowserCacheDuration="0" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/RegistroArtista.js" />
        </Scripts>
    </cc:ScriptCombine>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNombre" runat="server" ClientIDMode="Static" MaxLength="50" CssClass="form-control" placeholder="Ingrese Nombre" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="user-header" style="text-align: center;">
                                    <asp:Image CssClass="user-image" Style="max-height: 200px;" alt="" ID="imgArtistaImagen" runat="server" ClientIDMode="Static" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
    ...
    <asp:HiddenField ID="hdArtistaImagen" runat="server" ClientIDMode="Static" />
</asp:Content>
