...
public partial class Forms_Maestro_Artista : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        obj_MasterPage.TituloPagina = "Artista";
    ...
    [WebMethod]
    public static object ListarArtista(
        int? int_pIdArtista, string str_pNombre, string str_pEstado, int? int_pNumPagina, int? int_pTamPagina)
    {
        ...
        return Kruma.KantaPe.Negocio.Artista.Listar(str_pNombre, str_pEstado, int_pNumPagina, int_pTamPagina);
    }

    [WebMethod]
    public static Kruma.Core.Util.Common.ProcessResult ModificarEstado(
        int int_pIdArtista, string str_pEstado)
    {
        Kruma.KantaPe.Entidad.Artista obj_Artista = new Kruma.KantaPe.Entidad.Artista();
        obj_Artista.IdArtista = int_pIdArtista;
        obj_Artista.Estado = str_pEstado;
        return Kruma.KantaPe.Negocio.Artista.ModificarEstado(obj_Artista);
    }
