<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Cancion.aspx.cs" Inherits="Forms_Maestro_Cancion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Maestro/Cancion.js" />
        </Scripts>
    </cc:ScriptCombine>
            ...
            <div class="box box-warning collapsed-box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="ddlCancionSolicitud">Solicitud:</label>
                                <asp:DropDownList ID="ddlCancionSolicitud" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
