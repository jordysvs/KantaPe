<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="RegistroEvento.aspx.cs" Inherits="Forms_Configuracion_RegistroEvento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Compress="false">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Configuracion/RegistroEvento.js" />
        </Scripts>
    </cc:ScriptCombine>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div id="txtFechaEvento" class="input-group date datetime">
                                    <input id="txtFechaEvento_input" name="txtFechaEvento_input" class="form-control" size="16" type="text" value="" placeholder="Ingrese la fecha del evento" />
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="user-header" style="text-align: center;">
                                    <asp:Image CssClass="user-image" Style="max-height: 200px;" alt="" ID="imgEventoImagen" runat="server" ClientIDMode="Static" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
    ...
    <asp:HiddenField ID="hdIdEvento" runat="server" ClientIDMode="Static" />
    ...
    <asp:HiddenField ID="hdEventoImagen" runat="server" ClientIDMode="Static" />
