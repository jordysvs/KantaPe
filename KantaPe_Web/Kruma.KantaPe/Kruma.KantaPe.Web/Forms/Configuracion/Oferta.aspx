<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Oferta.aspx.cs" Inherits="Forms_Configuracion_Oferta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Configuracion/Oferta.js" />
        </Scripts>
    </cc:ScriptCombine>
            ...
            <div class="box box-warning collapsed-box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtFechaInicio">Fecha de Vencimiento Del:</label>
                                <div id="txtFechaInicio" class="input-group date datetime">
                                    <input id="txtFechaInicio_input" name="txtFechaInicio_input" class="form-control" size="16" type="text" value="" placeholder="Ingrese la fecha de inicio" />
