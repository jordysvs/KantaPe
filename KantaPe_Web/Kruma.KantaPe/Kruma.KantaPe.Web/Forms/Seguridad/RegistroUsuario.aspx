...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Minify="false" Combine="false">
        <Scripts>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtNombreBuscadorPersona" class="form-control" maxlength="20" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtNroDocumentoBuscadorPersona" class="form-control" maxlength="20" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
