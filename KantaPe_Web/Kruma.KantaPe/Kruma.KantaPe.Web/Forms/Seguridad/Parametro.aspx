<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Parametro.aspx.cs" Inherits="Forms_Seguridad_Parametro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    <cc:ScriptCombine ID="ScriptCombiner" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx">
        <Scripts>
            ...
            <cc:ScriptReference Path="~/Script/Forms/Seguridad/Parametro.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="50" />
                            </div>
                        </div>
                    </div>
                </div>
