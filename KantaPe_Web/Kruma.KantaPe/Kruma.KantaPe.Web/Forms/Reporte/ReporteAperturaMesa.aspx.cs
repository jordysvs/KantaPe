...
public partial class Forms_Reporte_ReporteAperturaMesa : System.Web.UI.Page
{
    #region Eventos
    ...
    private void CargaInicial()
    {
        ...
        obj_MasterPage.TituloPagina = "Reporte - Apertura de mesa";
    ...
    [WebMethod]
    public static object ReporteAperturaMesa(
            ...
            int? int_pTamPagina)
    {
        return Kruma.KantaPe.Negocio.Apertura.ReporteAperturaMesa(str_pNombreCompleto, int_pIdEmpresa, int_pIdLocal, dt_pFechaInicio, dt_pFechaFin, int_pIdUbicacionTipo, int_pNroUbicacion, int_pNumPagina, int_pTamPagina);
    }

    [WebMethod]
    public static object ListarAperturaMesaTop(
            string str_pNombreCompleto,
            int? int_pIdEmpresa,
            int? int_pIdLocal,
            DateTime? dt_pFechaInicio,
            ...
            int? int_pNroUbicacion)
    {
        return Kruma.KantaPe.Negocio.Apertura.ListarAperturaMesaTop(str_pNombreCompleto, int_pIdEmpresa, int_pIdLocal, dt_pFechaInicio, dt_pFechaFin, int_pIdUbicacionTipo, int_pNroUbicacion);
    }
    [WebMethod]
    public static object ListarAperturaMesaMozoTop(
            string str_pNombreCompleto,
            int? int_pIdEmpresa,
            int? int_pIdLocal,
            DateTime? dt_pFechaInicio,
            DateTime? dt_pFechaFin)
    {
        return Kruma.KantaPe.Negocio.Apertura.ListarAperturaMesaMozoTop(str_pNombreCompleto, int_pIdEmpresa, int_pIdLocal, dt_pFechaInicio, dt_pFechaFin);
    }
    #endregion
}