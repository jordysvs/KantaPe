<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="ReporteUsuarioFrecuente.aspx.cs" Inherits="Forms_Reporte_ReporteUsuarioFrecuente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" runat="Server">
    ...
    <cc:ScriptCombine ID="ScriptCombine" runat="server" ScriptHandler="~/Ashx/Combine/ScriptHandler.ashx" Combine="false" Minify="false">
        <Scripts>
            <cc:ScriptReference Path="~/Script/Forms/Reporte/ReporteUsuarioFrecuente.js" />
        </Scripts>
    </cc:ScriptCombine>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control" ClientIDMode="Static" MaxLength="50" placeholder="Ingrese el usuario" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Top 5 de usuario más frecuentes</h3>
                                    <div class="box-tools pull-right">
                        ...
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <h3 class="box-title">Top 5 de pedido de nuevas canciones</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                    </div>
                    ...
                    <%--<div class="row">
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <h3 class="box-title">Top 5 de mayor consumo (S/.)</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <h3 class="box-title">Top 5 de cancelación de pedido</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                    </div>
