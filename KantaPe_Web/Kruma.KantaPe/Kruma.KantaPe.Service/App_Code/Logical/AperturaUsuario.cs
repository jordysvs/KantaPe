...
namespace Kruma.KantaPe.Service.Logical
{
    ...
    public class AperturaUsuario : IAperturaUsuario
    {
        ...
        public Entity.ServiceResult<Core.Util.Common.ProcessResult> Modificar(Entidad.AperturaUsuario AperturaUsuario)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.AperturaUsuario.ModificarMovil(AperturaUsuario));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.AperturaUsuario/Cancelar", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }
        ...
        public Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario> Obtener(string IdLocal, string IdApertura, string IdAperturaUsuario, string IdUsuario)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario> obj_Resultado = null;

            try
            {
                int int_IdLocal = int.Parse(IdLocal);
                int int_IdApertura = int.Parse(IdApertura);
                int int_IdAperturaUsuario = int.Parse(IdAperturaUsuario);
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario>
                    (Kruma.KantaPe.Negocio.AperturaUsuario.ObtenerMovil(int_IdLocal, int_IdApertura, int_IdAperturaUsuario, IdUsuario));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Usuario/ObtenerMovil", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }


        public Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario> ObtenerEstadoAperturaUsuario(string IdLocal, string IdApertura, string IdAperturaUsuario, string IdUsuario)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario> obj_Resultado = null;
            ...
            try
            {
                ...
                int int_IdAperturaUsuario = int.Parse(IdAperturaUsuario);
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario>
                    (Kruma.KantaPe.Negocio.AperturaUsuario.ObtenerEstadoAperturaUsuario(int_IdLocal, int_IdApertura, int_IdAperturaUsuario, IdUsuario));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.AperturaUsuario>
        ...
        public Entity.ServiceResult<Core.Util.Common.ProcessResult> ModificarAdministrador(int int_pIdApertura, int int_pIdLocal,string int_pIdAdministrador, string int_pIdNuevoAdministrador)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.AperturaUsuario.ModificarAdministrador(int_pIdApertura, int_pIdLocal,int_pIdAdministrador, int_pIdNuevoAdministrador));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.AperturaUsuario/ModificarAdministrador", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }


        public Entity.ServiceResult<Core.Util.Common.ProcessResult> ModificarAperturaCancion(Entidad.AperturaCancion AperturaCancion)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.AperturaCancion.ModificarMovil(AperturaCancion));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
