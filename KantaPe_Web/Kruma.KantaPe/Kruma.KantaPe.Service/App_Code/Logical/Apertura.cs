...
namespace Kruma.KantaPe.Service.Logical
{
    ...
    public class Apertura : IApertura
    {
        ...
        public Entity.ServiceResult<Core.Util.Common.ProcessResult> Insertar(Entidad.Apertura Apertura)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.Apertura.Insertar(Apertura));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/Insertar", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }

        public Entity.ServiceResult<Core.Util.Common.ProcessResult> Cerrar(Entidad.Apertura Apertura)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.Apertura.Cerrar(Apertura));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/Cerrar", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }

        public Entity.ServiceResult<Entidad.Apertura> ObtenerActual(string IdLocal, string IdUbicacion)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.Apertura> obj_Resultado = null;
            try
            {
                int int_IdLocal = int.Parse(IdLocal);
                int int_IdUbicacion = int.Parse(IdUbicacion);
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.KantaPe.Entidad.Apertura>(Kruma.KantaPe.Negocio.Apertura.ObtenerActual(int_IdLocal, int_IdUbicacion));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.KantaPe.Entidad.Apertura>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/ObtenerActual", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }

        public Entity.ServiceResult<Core.Util.Common.ProcessResult> CancelarCancion(Entidad.AperturaCancion AperturaCancion)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.AperturaCancion.Cancelar(AperturaCancion));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/CancelarCancion", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }


        public Entity.ServiceResult<Core.Util.Common.List<Entidad.AperturaCancion>> ListarCancion(string IdLocal, string IdApertura, string IdUsuario, string IdAperturaCancionTipo)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<
                Kruma.Core.Util.Common.List<
                    Kruma.KantaPe.Entidad.AperturaCancion>> obj_Resultado = null;
            try
            {
                ...
                string str_IdUsuario = IdUsuario == Constante.NULLTYPE ? null : IdUsuario;
                int? int_IdAperturaCancionTipo = IdAperturaCancionTipo == Constante.NULLTYPE ? null : (int?)int.Parse(IdAperturaCancionTipo);

                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                Kruma.Core.Util.Common.List<Kruma.KantaPe.Entidad.AperturaCancion>>(
                Kruma.KantaPe.Negocio.AperturaCancion.Listar(int_IdLocal, int_IdApertura, null, str_IdUsuario, null, int_IdAperturaCancionTipo, null, Kruma.KantaPe.Entidad.Constante.Estado_Activo, null, null));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                                         Kruma.Core.Util.Common.List<
                                            Kruma.KantaPe.Entidad.AperturaCancion>>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/ListarCancion", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }

       
        public Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> SolicitarCancion(Entidad.AperturaCancion AperturaCancion)
        {
            Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult> obj_Resultado = null;
            try
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<
                    Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.KantaPe.Negocio.AperturaCancion.Solicitar(AperturaCancion));
            }
            catch (Exception obj_pExcepcion)
            {
                obj_Resultado = new Kruma.KantaPe.Service.Entity.ServiceResult<Kruma.Core.Util.Common.ProcessResult>
                    (Kruma.Core.Configuration.ConfigurationManager.Default.ApplicationManager["MensajeError"].Value);
                Kruma.Core.Log.LogManager.Write("Exceptions", "Kruma.KantaPe.Service.Logical.Apertura/SolicitarCancion", obj_pExcepcion.Message);
            }
            return obj_Resultado;
        }
