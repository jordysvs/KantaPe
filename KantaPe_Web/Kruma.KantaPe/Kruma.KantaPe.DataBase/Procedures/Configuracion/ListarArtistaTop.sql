create PROCEDURE [dbo].[ListarArtistaTop] 
/*
'**********************************************************************************
'* Procedimiento almacenado de ListarArtistaTop
'* Input :
		@pIdLocal - Id del 
		@pFechaInicio
		@pFechaFin
...
AS
BEGIN
			select CPD.Direccion as Local_Direccion,ar.nombre as Artista_Nombre, AR.IdArtista as Artista_IdArtista, count(1) as cantidad
            ...
            group by CPD.Direccion, ar.nombre, AR.IdArtista
